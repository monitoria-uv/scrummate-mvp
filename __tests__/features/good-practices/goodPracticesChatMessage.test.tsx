// Archivo: GoodPracticesChatMessage.test.tsx
...
describe('<ScrumAssistantChatMessage />', () => {
  ...
  it('se monta correctamente con mensaje de usuario', () => {
    render(<GoodPracticesChatMessage message={mockUserMessage} />);
  ...
  it('se monta correctamente con mensaje de asistente', () => {
    render(<GoodPracticesChatMessage message={mockAssistantMessage} />);
  ...
  it('renderiza el avatar correcto para cada tipo de mensaje', () => {
    ...
    const { rerender } = render(<GoodPracticesChatMessage message={mockUserMessage} />);
    ...
    rerender(<GoodPracticesChatMessage message={mockAssistantMessage} />);
    expect(screen.getByTestId('avatar-fallback')).toHaveTextContent('🧠');
  });
  ...
  it('maneja correctamente mensajes sin sender definido', () => {
    ...
    render(<GoodPracticesChatMessage message={invalidMessage} />);
