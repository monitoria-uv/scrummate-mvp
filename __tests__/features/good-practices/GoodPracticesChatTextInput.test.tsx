// Archivo: GoodPracticesChatTextInput.test.tsx
...
describe('<ScrumAssistantChatTextInput />', () => {
  ...
  it('se monta correctamente con todas las props', () => {
    render(<GoodPracticesChatTextInput {...mockProps} />);

    expect(screen.getByTestId('chat-text-input')).toBeInTheDocument();
    expect(screen.getByPlaceholderText('Habla con tu asistente de buenas prácticas Scrum...')).toBeInTheDocument();
  });
  ...
  it('maneja correctamente el evento onSend', () => {
    render(<GoodPracticesChatTextInput {...mockProps} value="test message" />);
  ...
  it('deshabilita el botón cuando loading es true', () => {
    render(<GoodPracticesChatTextInput {...mockProps} loading={true} />);

    expect(screen.getByTestId('send-button')).toBeDisabled();
  });

  it('deshabilita el botón cuando el valor está vacío', () => {
    render(<GoodPracticesChatTextInput {...mockProps} value="" />);
