...
jest.mock('@/components/ui/features/scrum-assistant/scrumAssistantChatHeader', () => ({
  ScrumAssistantChatHeader: () => <div data-testid="chat-header">Chat Header</div>,
}));
...
jest.mock('@/components/ui/features/scrum-assistant/scrumAssistantChatWindow', () => {
  const originalModule = jest.requireActual(
    '@/components/ui/features/scrum-assistant/scrumAssistantChatWindow',
  );
  return {
    ...originalModule,
    ScrumAssistantChatWindow: jest
      .fn()
