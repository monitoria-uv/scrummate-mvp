// Archivo: MeetAssistantChatMessage.test.tsx
...
describe('<ScrumAssistantChatMessage />', () => {
  ...
  it('se monta correctamente con mensaje de usuario', () => {
    render(<MeetAssistantChatMessage message={mockUserMessage} />);
  ...
  it('se monta correctamente con mensaje de asistente', () => {
    render(<MeetAssistantChatMessage message={mockAssistantMessage} />);
  ...
  it('renderiza el avatar correcto para cada tipo de mensaje', () => {
    ...
    const { rerender } = render(<MeetAssistantChatMessage message={mockUserMessage} />);
    ...
    rerender(<MeetAssistantChatMessage message={mockAssistantMessage} />);
    expect(screen.getByTestId('avatar-fallback')).toHaveTextContent('🧠');
  });
  ...
  it('maneja correctamente mensajes sin sender definido', () => {
    ...
    render(<MeetAssistantChatMessage message={invalidMessage} />);
